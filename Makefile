...
CXX_FLAGS = -Wno-deprecated-gpu-targets -g -G -O2 -std=c++17 --generate-line-info -arch=sm_89 -Xcudafe "--diag_suppress=611" -I $(INC_DIR) -I $(OPENCV_INCLUDE_DIR)
LD_FLAGS = $(CUDA_LD_FLAGS) $(OPENCV_LD_FLAGS) -Wno-deprecated-gpu-targets
